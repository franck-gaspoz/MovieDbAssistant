...
param([string]$title="",[string]$year="",[string]$country="",[string]$ext="") 
...
./movie-db-scrapper-windows-64bit-intel-1.1.1.exe imdb test.json $title "release_date=$year-01-01,$year-12-31&count=10&country_of_origin=$country$ext"
