...
# default to: SHA256
& 'C:\Program Files (x86)\Windows Kits\10\bin\10.0.22621.0\x64\makeappx.exe' pack /d content /p FranckGaspoz.Software.MovieDbAssistant_1.0.0_x64_win.msix

#add-appxpackage –register AppxManifest.xml

# unpack (test)
rmdir extract -recurse
& 'C:\Program Files (x86)\Windows Kits\10\bin\10.0.22621.0\x64\makeappx.exe' unpack /d extract /p FranckGaspoz.Software.MovieDbAssistant_1.0.0_x64_win.msix

# sign
#method (AppxBlockMap.xml:BlockMap:HashMethod) : http://www.w3.org/2001/04/xmlenc#sha256

& 'C:\Program Files (x86)\Windows Kits\10\bin\10.0.22621.0\x64\SignTool.exe' sign /fd SHA256 /a /f franck-gaspoz-software-cert.pfx /p mypassword1234 FranckGaspoz.Software.MovieDbAssistant_1.0.0_x64_win.msix

## Done Adding Additional Store
## Successfully signed: MovieDbAssistant_1.0.0_x64_win.msix

Add-AppxPackage -Path '.\FranckGaspoz.Software.MovieDbAssistant_1.0.0_x64_win.msix'
Get-AppxPackage -publisher "CN=Franck Gaspoz Software, O=Franck Gaspoz Corporation, C=US"
